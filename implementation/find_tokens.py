...
INPUT = 'C:/Users/Damilola/Documents/MSC UI/THESIS/STANCE DETECTION/IMPLEMENTATION WITH SPYDER/rawTweets/additionalTweetsStanceDetection_small.json'
...
def findTokensPhrases(phrasemodel="phrase.model", useDev=False):
    ...
    for line in open(INPUT, 'r', errors='ignore'):
        twcntr += 1
